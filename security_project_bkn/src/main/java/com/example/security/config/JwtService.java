...
public class JwtService {
    ...
    private static final String SECRET_KEY = "96b51601c561b0a0bfdf72f4136bdf7c95e0b9b743aa2732dc78a7f8fe687828";
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder().setClaims(extraClaims).setSubject(userDetails.getUsername())
                ...
                .setExpiration(new Date(System.currentTimeMillis()+ 1000 * 60 * 15))  // .. minuti di validita token
